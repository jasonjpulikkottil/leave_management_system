...
<div class="col-6 align-items-center shadow-none text-center">
<a href="/view-leave-history" class="{{Request::path()==='view-leave-history'?'text-white active':'text-dark'}}  p-4 ctm-border-right ctm-border-left"><span class="lnr lnr-apartment pr-0 pb-lg-2 font-23"></span><span class="">Leave Management</span></a>
</div>
<div class="col-6 align-items-center shadow-none text-center">
